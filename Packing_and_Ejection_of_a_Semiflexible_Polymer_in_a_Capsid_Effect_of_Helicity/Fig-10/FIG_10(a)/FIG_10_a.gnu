...
plot \
    'unpack_kappaphi0.txt' every 90 using 1:2 w p ls 1 title "$0$", \
    'unpack_kappaphi5.txt' every 90 using 1:2 w p ls 2 title "$5$", \
    'unpack_kappaphi15.txt' every 90 using 1:2 w p ls 3 title "$15$", \
    'unpack_kappaphi30.txt' every 90 using 1:2 w p ls 4 title "$30$"
